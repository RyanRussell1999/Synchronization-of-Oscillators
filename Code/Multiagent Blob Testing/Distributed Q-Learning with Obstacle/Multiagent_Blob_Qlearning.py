...
if start_q_table_1 is None:
    q_table_1 = np.random.uniform(low=0,high=1,size=(19,19,19,19,19,19,9))
else:
    with open(start_q_table_1, "rb") as f:
        q_table_1 = pickle.load(f)
 
if start_q_table_2 is None:
    q_table_2 = np.random.uniform(low=0,high=1,size=(19,19,19,19,19,19,9))
else:
    with open(start_q_table_2, "rb") as f:
        q_table_2 = pickle.load(f)
        
if start_q_table_3 is None:
    q_table_3 = np.random.uniform(low=0,high=1,size=(19,19,19,19,19,19,9))
else:
...
for episode in range(EPISODES):
    ...
    # Get Distance apart from each agent for every agent
        obs_1 = [A[0][1]*(Agent1.x - Agent2.x), A[0][1]*(Agent1.y - Agent2.y), A[0][2]*(Agent1.x - Agent3.x), A[0][2]*(Agent1.y - Agent3.y), Agent1.x - Obstacle1.x, Agent1.y - Obstacle1.y]
        obs_2 = [A[1][0]*(Agent2.x - Agent1.x), A[1][0]*(Agent2.y - Agent1.y), A[1][2]*(Agent2.x - Agent3.x), A[1][2]*(Agent2.y - Agent3.y), Agent2.x - Obstacle1.x, Agent2.y - Obstacle1.y]
        obs_3 = [A[2][0]*(Agent3.x - Agent1.x), A[2][0]*(Agent3.y - Agent1.y), A[2][1]*(Agent3.x - Agent2.x), A[2][1]*(Agent3.y - Agent2.y), Agent3.x - Obstacle1.x, Agent3.y - Obstacle1.y]
    ...
    # Take an action for each agent    
        ...
        new_obs_1 = [A[0][1]*(Agent1.x - Agent2.x), A[0][1]*(Agent1.y - Agent2.y), A[0][2]*(Agent1.x - Agent3.x), A[0][2]*(Agent1.y - Agent3.y), Agent1.x - Obstacle1.x, Agent1.y - Obstacle1.y]
        new_obs_2 = [A[1][0]*(Agent2.x - Agent1.x), A[1][0]*(Agent2.y - Agent1.y), A[1][2]*(Agent2.x - Agent3.x), A[1][2]*(Agent2.y - Agent3.y), Agent2.x - Obstacle1.x, Agent2.y - Obstacle1.y]
        new_obs_3 = [A[2][0]*(Agent3.x - Agent1.x), A[2][0]*(Agent3.y - Agent1.y), A[2][1]*(Agent3.x - Agent2.x), A[2][1]*(Agent3.y - Agent2.y), Agent3.x - Obstacle1.x, Agent3.y - Obstacle1.y]

#   Distributed Multiagent Q-Learning - 3 blobs
#   -------------------------------------------
#   Author: Ryan Russell
#   
...
for episode in range(EPISODES):
    ...
    # Get Distance apart from each agent for every agent
        obs_1 = [A[0][1]*(Agent1.x - Agent2.x), A[0][1]*(Agent1.y - Agent2.y), A[0][2]*(Agent1.x - Agent3.x), A[0][2]*(Agent1.y - Agent3.y)]
        obs_2 = [A[1][0]*(Agent2.x - Agent1.x), A[1][0]*(Agent2.y - Agent1.y), A[1][2]*(Agent2.x - Agent3.x), A[1][2]*(Agent2.y - Agent3.y)]
        obs_3 = [A[2][0]*(Agent3.x - Agent1.x), A[2][0]*(Agent3.y - Agent1.y), A[2][1]*(Agent3.x - Agent2.x), A[2][1]*(Agent3.y - Agent2.y)]
    ...
    # Take an action for each agent    
        ...
        new_obs_1 = [A[0][1]*(Agent1.x - Agent2.x), A[0][1]*(Agent1.y - Agent2.y), A[0][2]*(Agent1.x - Agent3.x), A[0][2]*(Agent1.y - Agent3.y)]
        new_obs_2 = [A[1][0]*(Agent2.x - Agent1.x), A[1][0]*(Agent2.y - Agent1.y), A[1][2]*(Agent2.x - Agent3.x), A[1][2]*(Agent2.y - Agent3.y)]
        new_obs_3 = [A[2][0]*(Agent3.x - Agent1.x), A[2][0]*(Agent3.y - Agent1.y), A[2][1]*(Agent3.x - Agent2.x), A[2][1]*(Agent3.y - Agent2.y)]
